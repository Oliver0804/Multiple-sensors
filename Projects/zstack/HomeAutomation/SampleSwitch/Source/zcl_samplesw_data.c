...
const uint8 zclSampleSw_ManufacturerName[] = { 16, 'O','e','x','a','s','I','n','s','t','r','u','m','e','n','t','s' };
const uint8 zclSampleSw_ModelId[] = { 16, 'O','l','i','v','e','r','0',' ',' ',' ',' ',' ',' ',' ',' ',' ' };
const uint8 zclSampleSw_DateCode[] = { 16, '2','0','2','2','0','4','2','4',' ',' ',' ',' ',' ',' ',' ',' ' };
